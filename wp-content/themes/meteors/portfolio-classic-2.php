<?php
/**
 * Template Name: Portfolio Classic 2 Columns
...
<div class="inner">
	...
	?>
	<div class="element classic2_cols <?php echo esc_attr($portfolio_item_set); ?>">
		...
		<br class="clear"/>
		<div id="portfolio_desc_<?php echo esc_attr($portfolio_ID); ?>" class="portfolio_desc portfolio2 filterable">
