<?php
/**
 * Template Name: Portfolio Grid Masonry
...
<div class="inner">
	...
	?>
	<div class="element grid classic3_cols <?php echo esc_attr($portfolio_item_set); ?>">
			...
			?>		
				<?php
	                ...
	                <?php
        				...
        				case 'Image':
					?>
					<a data-title="<?php echo esc_attr(get_the_title()); ?><?php echo remove_shortcode(get_the_content()); ?>" href="<?php echo esc_url($image_url[0]); ?>" class="fancy-gallery">
						<img src="<?php echo esc_url($small_image_url[0]); ?>" alt="" />
						<div id="portfolio_desc_<?php echo esc_attr($portfolio_ID); ?>" class="portfolio_title">
        					<div class="table">
        						<div class="cell">
