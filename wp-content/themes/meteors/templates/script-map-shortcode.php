...
?>
jQuery(document).ready(function(){ jQuery("#<?php echo $map_data['id']; ?>").simplegmaps(<?php echo $marker; ?>); });
<?php
if(isset($_GET['fullheight']) && $_GET['fullheight'] == 'true')
{
?>
jQuery(document).ready(function(){ 
	var mapHeight = jQuery("#<?php echo $map_data['id']; ?>").parent().parent().height();
	if(mapHeight>0)
	{
		jQuery("#<?php echo $map_data['id']; ?>").css('height', mapHeight+'px');
	}
});
<?php
}
