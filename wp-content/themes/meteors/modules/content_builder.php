...
?>
	...
	<?php
			...
			{
	?>
			<li><a href="#tabs-<?php echo $tab_key; ?>"><?php echo $ppb_tab; ?></a></li>
	<?php	
			}
	?>
			</ul>
	...
	?>
			<li id="<?php echo $ppb_form_item; ?>" class="ui-state-default <?php echo $ppb_form_item_size[0]; ?> <?php echo $ppb_form_item_data_obj->shortcode; ?>" data-current-size="<?php echo $ppb_form_item_size[0]; ?>">
				...
				<a data-rel="<?php echo $ppb_form_item; ?>" href="<?php echo admin_url('admin-ajax.php?action=pp_ppb&ppb_post_type=page&shortcode='.$ppb_form_item_data_obj->shortcode.'&rel='.$ppb_form_item.'&width=800&height=900'); ?>" class="ppb_edit"></a>
