...
function pp_shortcode_generator_options() {
	...
	$shortcodes = array(
		...
		'tg_grid_gallery' => array(
			...
			'desc' => array(
				'gallery_id' => 'Select gallery you want to display its images',
				'margin' => 'Select to display gallery with margin',
			),
			'options' => array(
				'gallery_id' => $galleries_select,
				'margin' => array(
			...
			<div id="div_<?php echo $shortcode_name; ?>" class="rm_section" style="display:none">
				...
				?>
							...
							?>
									...
									<input type="text" id="<?php echo $shortcode_name; ?>_<?php echo $attr; ?>" style="width:100%" class="attr" data-attr="<?php echo $attr; ?>"/>
							...
							?>
									...
									<textarea id="<?php echo $shortcode_name; ?>_<?php echo $attr; ?>" style="width:100%" class="attr" data-attr="<?php echo $attr; ?>"></textarea>
							...
							?>
									...
									<input type="text" id="<?php echo $shortcode_name; ?>_<?php echo $attr; ?>" style="width:100%" class="attr color_picker" data-attr="<?php echo $attr; ?>" readonly/>
									
									<div id="<?php echo $shortcode_name; ?>_<?php echo $attr; ?>_bg" class="colorpicker_bg" onclick="jQuery('#<?php echo $shortcode_name; ?>_text').click()" style="background-image: url(<?php echo get_template_directory_uri(); ?>/functions/images/trigger.png);margin-top:3px">&nbsp;</div><br/>
							...
							?>
									...
									<select id="<?php echo $shortcode_name; ?>_<?php echo $attr; ?>" style="width:100%" class="attr" data-attr="<?php echo $attr; ?>">
				...
				<textarea id="<?php echo $shortcode_name; ?>_code" style="width:100%;height:200px;word-wrap: break-word;" rows="3" readonly="readonly" class="code_area" wrap="off"></textarea>
